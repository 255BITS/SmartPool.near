...
def generate_market_prompts(parsed_data):
    """
    Generates a separate prompt for every entry in markets, including event information.

    Args:
        parsed_data: The list of parsed event dictionaries.

    Returns:
        A list of prompts for each market.
    """
    prompts = []
    for event in parsed_data:
...
def main():
    ...
    if data:
        ...
        # Generate and print market prompts
        prompts = generate_market_prompts(data)
